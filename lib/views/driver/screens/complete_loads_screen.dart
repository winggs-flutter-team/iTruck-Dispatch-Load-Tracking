...
class DriverCompleteLoadScreen extends StatefulWidget {
  const DriverCompleteLoadScreen({Key? key}) : super(key: key);

  @override
  State<DriverCompleteLoadScreen> createState() =>
      _DriverCompleteLoadScreenState();
}

class _DriverCompleteLoadScreenState extends State<DriverCompleteLoadScreen> {
