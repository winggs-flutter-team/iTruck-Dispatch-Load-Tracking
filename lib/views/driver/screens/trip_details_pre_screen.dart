...
class DriverTripDetailsPreScreen extends StatefulWidget {
  const DriverTripDetailsPreScreen({Key? key}) : super(key: key);

  @override
  State<DriverTripDetailsPreScreen> createState() =>
      _DriverTripDetailsPreScreenState();
}

class _DriverTripDetailsPreScreenState
    extends State<DriverTripDetailsPreScreen> {
