...
class DispatcherPickupDetailView extends StatefulWidget {
  final LoadModel load;

  final int? initindex;

  const DispatcherPickupDetailView(
      {Key? key, required this.load, this.initindex})
      : super(key: key);

  @override
  State<DispatcherPickupDetailView> createState() =>
      _DispatcherPickupDetailViewState();
}

class _DispatcherPickupDetailViewState
    extends State<DispatcherPickupDetailView> {
  settimeremain() {
