...
class DispatcherDeliveryDetailView extends StatefulWidget {
  final LoadModel load;

  final int? initindex;

  const DispatcherDeliveryDetailView(
      {Key? key, required this.load, this.initindex})
      : super(key: key);

  @override
  State<DispatcherDeliveryDetailView> createState() =>
      _DispatcherDeliveryDetailViewState();
}

class _DispatcherDeliveryDetailViewState
    extends State<DispatcherDeliveryDetailView> {
  settimeremain() {
