...
class DispatcherSearchLoadsScreen extends StatefulWidget {
  const DispatcherSearchLoadsScreen({Key? key}) : super(key: key);

  @override
  State<DispatcherSearchLoadsScreen> createState() =>
      _DispatcherSearchLoadsScreenState();
}

class _DispatcherSearchLoadsScreenState
    extends State<DispatcherSearchLoadsScreen> {
