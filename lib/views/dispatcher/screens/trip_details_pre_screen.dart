...
import '../widgets/dispatcher_drawer.dart';

class DispatcherTripDetailsPreScreen extends StatefulWidget {
  const DispatcherTripDetailsPreScreen({Key? key}) : super(key: key);

  @override
  State<DispatcherTripDetailsPreScreen> createState() =>
      _DispatcherTripDetailsPreScreenState();
}

class _DispatcherTripDetailsPreScreenState
    extends State<DispatcherTripDetailsPreScreen> {
