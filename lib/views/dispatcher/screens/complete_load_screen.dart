...
class DispatcherCompleteLoadScreen extends StatefulWidget {
  const DispatcherCompleteLoadScreen({Key? key}) : super(key: key);

  @override
  State<DispatcherCompleteLoadScreen> createState() =>
      _DispatcherCompleteLoadScreenState();
}

class _DispatcherCompleteLoadScreenState
    extends State<DispatcherCompleteLoadScreen> {
