...
class PostLoadScreen extends StatefulWidget {
  ...
  @override
  State<PostLoadScreen> createState() => PostLoadScreenState();
}

class PostLoadScreenState extends State<PostLoadScreen> {
  int _pickupCount = 0;
...
//popup a dialog box after created a user
  ...
  _onsave(context) async {
    await DispatcherMethods().postLoad(pickups, deliveries, drivers,
        pickupLoadNumber, deliveryLoadNumber, notes, context);
  }
